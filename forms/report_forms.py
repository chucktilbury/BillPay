...
@class_wrapper
class BalancesReportForms(Forms):

    def __init__(self, notebook):
        self.logger.set_level(Logger.DEBUG)

        index = notebook.get_tab_index('Balances')
        ...
        self.add_title('Balance Report')

@class_wrapper
class TransactionsReportForms(Forms):
    ...
    def __init__(self, notebook):
        ...
        self.add_title('Transaction Report')
